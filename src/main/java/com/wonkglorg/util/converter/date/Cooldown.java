...
public class Cooldown {
	 ...
	 */
	public Cooldown(int cooldown, ChronoUnit unit) {
	 ...
	 */
	public Cooldown(int cooldown, ChronoUnit unit, long startTime) {
		this(Duration.of(cooldown, unit), startTime);
	}


	/**
	 * @return true if the time between the start and now is larger than the set cooldown
	 */
	...
	/**
	 * @return the remaining time in milliseconds from the current timestamp to when its expiration
	 */
