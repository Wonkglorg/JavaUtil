...
public class DateConverter {
    ...
    private static final Comparator<DateType> comparatorBiggestTimeFirst = Comparator.comparingLong(DateType::getMilliseconds).reversed();
    ...
    public static Map<DateType, Long> toTimeMap(long timeInMs, DateType... formats) {
        Map<DateType, Long> timeMap = new HashMap<>();
        List<DateType> dateList = Arrays.stream(formats).sorted(comparatorBiggestTimeFirst).toList();
