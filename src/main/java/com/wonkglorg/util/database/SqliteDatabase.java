...
public class SqliteDatabase extends Database {
    ...
    public void connect() {
        ...
        try {
            ...
            String connectionString = getDriver() + DESTINATION_PATH;
            connection = DriverManager.getConnection(connectionString);

        } catch (ClassNotFoundException | SQLException | IOException e) {
            System.out.printf(e.getClass().getName() + ": " + e.getMessage());
        }
    }

    /**
     * Copies the database file from the sourcePath to the destinationPath or creates a new file if it does not exist.
     *
     * @param databaseFile
     * @throws IOException
     */
