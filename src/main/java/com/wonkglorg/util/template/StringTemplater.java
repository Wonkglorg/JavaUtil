...
public class StringTemplater {
    ...
    //todo:jmd add way to add padding to templates or remove parts of the template if the value is empty
    ...
    /**
     * Sets the template indicator, formatted as "{%s}" where "%s" is the location of the placeholder variable and the { }
     * indicate the characters around the placeholder indicate what is considered a placeholder to look for
     *
