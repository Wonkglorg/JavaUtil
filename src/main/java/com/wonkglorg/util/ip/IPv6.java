...
public class IPv6 implements IP {
    ...
    /**
     * @return returns a shortened IPv6 with leading zeros removed and the longest sequence of zeros shortened to "::"
     */
    public String toShortenedIP() {
        ...
        ipParts = Arrays.stream(ipParts).map(part -> StringUtils.removeAllLeading(part, '0')).toArray(String[]::new);
